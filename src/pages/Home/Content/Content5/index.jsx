      ...
      <div className='grid grid-cols-5 gap-5'>
        {Languages.map((language) => (
          <div className='relative mx-auto group'>
            ...
            />
            <div className='absolute top-0 hidden capitalize text-white text-center text-[28.6px] 2xl:text-[48px] w-[150px] h-[150px] group-hover:flex justify-center items-center group-hover:bg-black group-hover:opacity-70 '>
              {language.title}
            </div>
          </div>
        ))}
